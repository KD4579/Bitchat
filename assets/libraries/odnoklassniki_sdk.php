...
class OdnoklassnikiSDK{
    ...
    {
        global $wo;
        self::$app_id = $wo['config']['OkAppId'];
        self::$app_public_key = $wo['config']['OkAppPublickey'];
        self::$app_secret_key = $wo['config']['OkAppSecretkey'];
        self::$redirect_url = $wo['config']['site_url']."/login-with.php";
    }
}
?>
