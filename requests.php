...
if ($wo['config']['membership_system'] == 1) {
    ...
    $non_login_array[] = 'trdc_payments';
    $non_login_array[] = 'stripe';
    $non_login_array[] = 'pay_with_trdc'; // Add your payment method handlers here
    $non_login_array[] = 'busd_bep20'; // Add your payment method handlers here
    $non_login_array[] = 'usdt_bep20';
    $non_login_array[] = 'fdusd_bep20';
    $non_login_array[] = 'usdt_trc20';
    $non_login_array[] = 'trdc_bep20';
}
