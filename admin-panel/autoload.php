...
<?php //} ?>
    ...
    <![endif]-->
    <?php if ($page == 'trdc-payments' || $page == 'manage-verification-reqeusts' || $page == 'monetization-requests' || $page == 'manage-user-ads') { ?>
        <!-- Css -->
                                        ...
                                        <?php if ($notify_count > 0) { ?>
                                            ...
                                            <?php if (!empty($notifications)) {
                                                    foreach ($notifications as $key => $notify) {
                                                        ...
                                                        if ($notify->type == 'bank') {
                                                            $page_ = 'trdc-payments';
                                                            $text = 'You have a new TRDC Payment awaiting your approval';
                                                        }
        ...
        <div class="navigation">
            ...
            <div class="navigation-menu-body">
                <ul>
                    ...
                    <?php } ?>
                    <?php if ($is_admin || ($is_moderoter && ($wo['user']['permission']['ads-settings'] == 1 || $wo['user']['permission']['manage-site-ads'] == 1 || $wo['user']['permission']['manage-user-ads'] == 1 || $wo['user']['permission']['trdc-payments'] == 1 || $wo['user']['permission']['payment-settings'] == 1 || $wo['user']['permission']['manage-currencies'] == 1 ))) { ?>
                    <li <?php echo ($page == 'ads-settings' || $page == 'manage-site-ads' || $page == 'manage-user-ads' || $page == 'trdc-payments' || $page == 'payment-settings' || $page == 'manage-currencies') ? 'class="open"' : ''; ?>>
                        <a href="#">
                            <span class="nav-link-icon">
                        ...
                        <ul class="ml-menu">
                            ...
                            <?php } ?>
                            <?php if ($is_admin || ($is_moderoter && $wo['user']['permission']['trdc-payments'] == 1)) { ?>
                            <li>
                                <a <?php echo ($page == 'trdc-payments') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('trdc-payments'); ?>" data-ajax="?path=trdc-payments">
                                    <span>Manage TRDC Payments</span>
                                </a>
                            </li>
                            <?php } ?>
                        </ul>
                    ...
                    <?php } ?>
                    <?php if ($is_admin) { ?>
                    <li <?php echo in_array($page, ['growth-intelligence','growth-presets','admin-activity-log','feed-algorithm','scheduled-posts','ghost-activity','announcement-banner','trdc-rewards','trdc-withdrawals','deposits','trading-bot','trading-bot-dashboard','staking-settings','creator-mode','news-bots']) ? 'class="open"' : ''; ?>>
                        <a href="#">
                            <span class="nav-link-icon">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a <?php echo ($page == 'deposits') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('deposits'); ?>" data-ajax="?path=deposits">BSC Deposits</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a <?php echo ($page == 'trading-bot-dashboard') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('trading-bot-dashboard'); ?>" data-ajax="?path=trading-bot-dashboard">Bot Dashboard</a>
                            </li>
                            <li>
