...
if ($f == 'download_updates') {
    if (Wo_CheckMainSession($hash_id) === true) {
        ...
        if (!empty($_GET['purchase_code'])) {
            ...
            $file          = file_get_contents("https://www.wowonder.com/check_for_updates.php?code={$purchase_code}&version=$version&full=true&url=$siteurl", false, stream_context_create($arrContextOptions));
